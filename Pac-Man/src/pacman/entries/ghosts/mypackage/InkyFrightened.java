...
public class InkyFrightened implements IAction, IBinaryNode {
...
/*
		...
		*/
		...
		return game.getApproximateNextMoveAwayFromTarget(iCurrent, pacCurrent, game.getGhostLastMoveMade(GHOST.INKY), DM.PATH);
